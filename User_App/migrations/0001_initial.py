    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friend_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='friend_list', to='User_App.friendlistmodel')),
            ],
        ),
        migrations.AddField(
            model_name='friendlistmodel',
            name='list_owner',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='list_owner', to=settings.AUTH_USER_MODEL),
        ),
    ]
